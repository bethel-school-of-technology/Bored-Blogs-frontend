...
var contributors = [
  new Contributor(
    ...
    //bio
    new Bio(
      [new Game("Settlers of Catan"), new Game("Ticket to Ride")],
      "12/09/1995",
  ...
  new Contributor(
    ...
    new Bio(
      ...
      new linksIguess(
        "https://github.com/Kayla-D-Miller",
        "https://en.wikipedia.org/wiki/Princess_Leia",
        "https://www.linkedin.com/in/kayla-miller-km/"
      ),
  ...
  new Contributor(
    ...
    new Bio(
      ...
      new linksIguess(
        "https://github.com/kamylaandrlik",
        "https://en.wikipedia.org/wiki/Anna_(Frozen)",
        "https://www.linkedin.com/in/kamyla-andrlik-6811bb6b/"
      ),
...
export class ContributorService {
  ...
  getContributors(): Observable<any> {
    ...
    if (Config.weAreUsingCloud) {
      ...
      var request = this.http
        .get<Contributor[]>(this.url + "/users/contributors")
        .pipe(
          map((foo) => {
            foo = foo.map((f) => {
  ...
  getContributor(id: number): Observable<any> {
    if (Config.weAreUsingCloud) {
